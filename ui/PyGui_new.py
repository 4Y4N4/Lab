...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(797, 496)
        self.ok_cancel = QtWidgets.QDialogButtonBox(Dialog)
        self.ok_cancel.setGeometry(QtCore.QRect(230, 260, 201, 20))
        self.ok_cancel.setOrientation(QtCore.Qt.Horizontal)
        self.ok_cancel.setStandardButtons(QtWidgets.QDialogButtonBox.Ok|QtWidgets.QDialogButtonBox.Reset)
        ...
        self.speedcontrol.valueChanged['int'].connect(Dialog.exec)
        self.sequenceselector.sliderReleased.connect(Dialog.exec)
        self.ok_cancel.accepted.connect(self.progressBar.reset)
        self.ok_cancel.accepted.connect(Dialog.exec)
        self.ok_cancel.rejected.connect(Dialog.accept)
        self.stepcontroler.valueChanged['int'].connect(Dialog.exec)
